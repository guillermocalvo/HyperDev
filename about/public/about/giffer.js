// originally from https://github.com/krasimir/gifffer
// but modified inline
...
function createContainer(w, h, el) {
  ...
  play.setAttribute('style', 'width:' + playSize + 'px;height:' + playSize + 'px;border-radius:' + (playSize/2) + 'px;background: rgba(0, 0, 0, 0.5);position:absolute;');
  ...
  el.onload = function() {
    ...
    con.addEventListener('click', function() {
      ...
      if(!playing) {
        ...
        // set size of gif
        console.log("height", dims.h);
        gif.setAttribute('style', 'width:' + dims.w + 'px;min-height:' + dims.h + 'px;');
